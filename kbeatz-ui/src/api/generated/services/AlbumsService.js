...
export class AlbumsService {
     ...
     * @throws ApiError
     */
    static listAlbums({ page, size = 20, albumArtist, composer, genre, yearFrom, yearTo, q, }) {
     ...
     * @throws ApiError
     */
    static updateAlbumTags({ albumId, requestBody, }) {
        return __request(OpenAPI, {
            method: 'PATCH',
            url: '/albums/{albumId}',
            path: {
     ...
     * @throws ApiError
     */
    static syncAlbumFromDiscogs({ albumId, requestBody, }) {
        return __request(OpenAPI, {
            method: 'POST',
